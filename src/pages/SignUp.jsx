          ...
          <input
            ...
            <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg">
              ...
              <p>
                <Link
                  to="/forgot-password"
                  className="text-blue-600 hover:text-blue-800 transition duration-200 ease-in-out font-medium"
                >
                  Forgot Password?
                </Link>
              </p>
            ...
            <button
            className="w-full bg-blue-600 text-white px-7 py-3 font-medium uppercase rounded shadow-md
